...
/*function findStuff(location,title) {
    ...
    for (let index = 0; index < jobs.length; index++) {
        ...
        if(element === us){
        console.log("from US"+ element)
    } else(element != us)

        console.log("forse hai ragione");
...
function search (){
  ...
  let title = document.getElementById("searchJob").value;
  let location = document.getElementById("searchPlace").value;
